...
public class PracticeFormPage extends BasePage {
    ...
    WebElement dateOfBDayInput;

    public PracticeFormPage enterDateOfBDay(String data) {
        click(dateOfBDayInput);
        String os = System.getProperty("os.name");
        System.out.println("My system is " + os);
        if (os.startsWith("Mac")) {
            dateOfBDayInput.sendKeys(Keys.COMMAND, "a");
        } else {
            dateOfBDayInput.sendKeys(Keys.CONTROL, "a");
        }
        dateOfBDayInput.sendKeys(data);
        dateOfBDayInput.sendKeys(Keys.ENTER);
        return this;
    }
    ...
    public PracticeFormPage verifySeccessRegistration(String title) {
